...
export interface IPaymentFailedOptions {
  hideBackButton?: boolean;
  text?: string;
}


export interface ICarouselTabsSlide {
  id: number;
  item: ReactElement;
}
export interface ICarouselTabsProps {
  slides: ICarouselTabsSlide[];
  className?: string;
	menu: any;
}
...
export interface IMainLayout {
  children: ReactNode | string
	isHero?: ReactElement;
	isParrotAndButterfly?: ReactElement;
	snakeOnTop?: boolean;
	isHome?: string;
	className?: string;
}
