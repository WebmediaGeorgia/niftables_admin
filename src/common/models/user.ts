import { Empty, AnyProperties } from './misc';
...
export interface IMetaMaskSendResponse extends AnyProperties {}
...
export interface IUserInfoSendResponse extends AnyProperties {}
