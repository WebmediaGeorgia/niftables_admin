...
import FaceBook from 'public/social-network-icons/facebook.svg';
import Twitter from 'public/social-network-icons/twitter.svg';
import Instagram from 'public/social-network-icons/instagram.svg';
import Youtube from 'public/social-network-icons/youtube.svg';
...
): Array<IDropDownItem> => [
  {
    ...
    submenu: [
      ...
      },
      {
        id: '2',
        name: 'My Packs',
        linkTo: '/my-profile/my-packs',
      },
      {
        id: '3',
        name: 'Liked NFTs',
        linkTo: '/my-profile/liked-nfts',
      },
      {
        id: '4',
        name: 'Profile settings',
        linkTo: '/settings?tab=setting',
      },
    ],
  },
  {
